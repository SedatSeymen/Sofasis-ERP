...
- **FaturaParametre** — Fatura ayarları (varsayılan seri, KDV tipi vb.).
- **SatisFaturaM / D** — Satış faturası başlık/satır; cari, tarih, döviz+kur, satır: stok/miktar/birim fiyat/iskonto/KDV/tevkifat; toplamlar; e-Belge ilişkisi. Onayda: cari alacak + stok çıkış + SMM (servisle).
- **AlisFaturaM / D** — Alış faturası; onayda: cari borç + stok giriş + ağırlıklı ortalama maliyet güncelleme.

## SatinAlmaYonetimi / SatisPazarlamaYonetimi

- **SASiparisM / D**, **SatisSiparisM / D** — Sipariş başlık/satır; sipariş→irsaliye→fatura akışı. Satış siparişinin üretime özgü kısmı (model konfigürasyonu, kumaş, ayak tipi/rengi) **üretim fazında** tam bağlanır.
