...
// yalnızca "veriyi çek ve ayrıştır" ile sınırlıdır; DB'ye yazma işini çağıran
// (TcmbDovizKuruGuncellemeController) yapar — test edilebilirlik için ayrıldı.
public sealed class TcmbDovizKuruService : IDovizKuruService
{
    public IReadOnlyList<DovizKuruDto> KurlariCek(DateTime tarih)
    {
        ...
        catch (Exception)
        {
            ...
            // sessizce boş liste dön, çağıran taraf bir sonraki girişte tekrar dener.
