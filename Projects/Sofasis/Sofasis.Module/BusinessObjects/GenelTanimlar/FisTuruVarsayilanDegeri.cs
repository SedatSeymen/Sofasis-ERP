 ...
 *                    tablo. HedefTip seçimi IFisTuruVarsayilanHedefi
 *                    arayüzünü uygulayan sınıflarla sınırlıdır; VarsayilanDeger
 *                    bu tipin gerçek bir kaydına XPWeakReference ile (tip
 *                    güvenli, polimorfik) referans verir. Aktif=false olan
 *                    satırlar otomatik uygulamada atlanır.
 * ****************************************************************************
 */
...
public class FisTuruVarsayilanDegeri : BaseClass
{
    ...
    // PropertyEditor (Sofasis.Blazor.Server\Editors\FisTuruVarsayilanDegerNesnePropertyEditor)
