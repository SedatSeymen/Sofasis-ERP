...
namespace Sofasis.Module.Controllers.Reports
{

    public partial class SatisSiparisReportController : ObjectViewController<ListView,SatisSiparisM>
    {
        SingleChoiceAction SatisSiparisReportController_Action;
        IList SelectedDataList;
        public SatisSiparisReportController()
        {
            InitializeComponent();
            SatisSiparisReportController_Action = new SingleChoiceAction(this,
                "SatisSiparisReportController_Action", PredefinedCategory.Edit)
            {
                Caption = "Satış Siparişlerini Yazdırma",
                ItemType = SingleChoiceActionItemType.ItemIsOperation,
                SelectionDependencyType = SelectionDependencyType.RequireMultipleObjects,
                ImageName = "Print"
            };
            SatisSiparisReportController_Action.Execute += SatisSiparisReportController_Action_Execute; ;
        }
        private void SatisSiparisReportController_Action_Execute(object sender, SingleChoiceActionExecuteEventArgs e)
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            // NOT: MasterKeyID, WW_SatisSiparisRapor dataview'ının kendi ayrı string(13) PK'sı; Faz B
            ...
            {
                filterList.Add(((SatisSiparisM)SelectedDataList[i]).Oid.ToString());
            }
            if (filterList.Count > 0)
            {
                ...
                if (controller != null)
                {
                    ...
                    sortlist.Append(new SortProperty("StokTanim", DevExpress.Xpo.DB.SortingDirection.Ascending));
        ...
        protected override void OnViewControlsCreated()
        {
            ...
            SatisSiparisReportController_Action.Items.Clear();
#pragma warning disable CS0618 // Type or member is obsolete
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            CriteriaOperator criteria = CriteriaOperator.Parse("DataTypeName  " +
                "In ('Sofasis.Module.BusinessObjects.WW_SatisSiparisRapor')");
            ...
            foreach (ReportDataV2 report in reportData)
            {
                ...
                SatisSiparisReportController_Action.Items.Add(item);
            }
        }
    }
}
