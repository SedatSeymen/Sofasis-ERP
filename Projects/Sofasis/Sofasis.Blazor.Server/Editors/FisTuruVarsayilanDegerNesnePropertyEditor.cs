 ...
 *             HedefTip her değiştiğinde (ImmediatePostData ile) bu editör
 *             kendini yeniler ve seçili tipin kayıtlarını listeler — ayrı bir
 *             "Değer Seç" düğmesine gerek kalmaz.
 * ****************************************************************************
 */
...
namespace Sofasis.Blazor.Server.Editors;
...
public class FisTuruVarsayilanDegerNesnePropertyEditor : BlazorPropertyEditorBase, IComplexViewItem
{
    ...
    // editörün yenilenmesi (Refresh) IComplexViewItem üzerinden DEĞİL, Sofasis.Module\Controllers\
    // FisTuruVarsayilanDegeriHedefTipDegistiController tarafından tetiklenir — bu editör
    // seviyesinde ObjectSpace.ObjectChanged aboneliği denendi ama bu nesnenin açıldığı nested
    // popup bağlamında güvenilir şekilde tetiklenmedi; Controller seviyesindeki abonelik
    // (aynı olay, View.ObjectSpace üzerinden) güvenilir şekilde çalışıyor.
